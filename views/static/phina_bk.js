  ...
  phina.define('phina.asset.Texture', {
    ...
    _load: function (resolve) {
      ...
      this.domElement.onerror = function (e) {
        ...
        e.target.src = "https://web.archive.org/web/20210331154846/http://dummyimage.com/128x128/444444/eeeeee&text=" + key;
      };
  ...
  phina.define('phina.app.BaseApp', {
    ...
    enableStats: function () {
      if (phina.global.Stats) {
        ...
        var STATS_URL = 'https://web.archive.org/web/20210331154846/https://cdnjs.cloudflare.com/ajax/libs/stats.js/r14/Stats.js';
    ...
    enableDatGUI: function (callback) {
      if (phina.global.dat) {
        ...
        var URL = 'https://web.archive.org/web/20210331154846/https://cdnjs.cloudflare.com/ajax/libs/dat-gui/0.5.1/dat.gui.js';
        var script = document.createElement('script');
        script.src = URL;
        document.body.appendChild(script);
        script.onload = function () {
  ...
  phina.define('phina.graphics.Canvas', {
    ...
    fitScreen: function (isEver) {
      ...
      var _fitFunc = function () {
        ...
        // if (!phina.isAndroid()) s.position = "absolute";
        s.position = "absolute";
        s.margin = "auto";
        s.left = "0px";
        s.top = "0px";
        ...
        if (rateWidth > rateHeight) { // 縦
          if (phina.isAndroid()) s.top = "300px";
          s.width = Math.floor(innerWidth) + "px";
          s.height = Math.floor(innerWidth * rate) + "px";
        }
        else {   // 横
          // if (phina.isAndroid()) s.top = "150px";
...
phina.namespace(function () {
  ...
  phina.define('phina.game.SplashScene', {
    ...
    _static: {
      defaults: {
        imageURL: 'https://web.archive.org/web/20210331154846/http://cdn.rawgit.com/phi-jp/phina.js/develop/logo.png',
      },
    },
  });
...
phina.namespace(function () {
  ...
  phina.define('phina.game.LoadingScene', {
    ...
    init: function (options) {
      ...
      this.superInit(options);
      //let btn = Shape({ width: 800, height: 600 });
	  let btn = Shape({ width: 1024, height: 768 });
      btn.backgroundColor = 'white';
      btn.setPosition(this.gridX.center(), this.gridY.center());
      btn.addChildTo(this);
      ...
      let label = Label({ text: 'loading.. 0%', fill: '#309ee4' });
      label.setPosition(this.gridX.center(), this.gridY.center() - 100);
      ...
      if (options.lie) {
        ...
        loader.onprogress = function (e) {
          ...
          this.loadingLabel.text = 'loading.. ' + Math.floor(e.progress * 100) + '%';
        }.bind(this);
      }
      ...
      this.gauge.onfull = function () {
        ...
        this.loadingLabel.text = "Tap to Start";
...
phina.namespace(function () {
  ...
  phina.define('phina.social.Twitter', {
    ...
    _static: {
      baseURL: 'https://web.archive.org/web/20210331154846/https://twitter.com/intent',
      defaults: {
        // type: 'tweet',
        text: 'Hello, world!',
        // screen_name: 'phi_jp',
        hashtags: 'javascript,phina',
        // url: 'https://web.archive.org/web/20210331154846/http://github.com/phi-jp/phina.js',
        url: phina.global.location && phina.global.location.href,
        // via: 'phi_jp',
      },
...
/*
     FILE ARCHIVED ON 15:48:46 Mar 31, 2021 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 02:38:13 Apr 02, 2021.
...
/*
playback timings (ms):
  PetaboxLoader3.datanode: 168.91 (4)
  exclusion.robots: 0.15
  esindex: 0.009
  CDXLines.iter: 20.265 (3)
  load_resource: 1136.693
  PetaboxLoader3.resolve: 1070.453
  exclusion.robots.policy: 0.14
  captures_list: 204.591
  LoadShardBlock: 179.048 (3)
